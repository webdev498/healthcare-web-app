...
@Component({
    selector: 'app-family-member-medical-info',
    templateUrl: './family-member-medical-info.component.html',
    styleUrls: ['./family-member-medical-info.component.css']
})

//-------------------------------------------------------------------------------
// Component Class Section
//-------------------------------------------------------------------------------
export class FamilyMemberMedicalInfoComponent implements OnInit {
	//---------------------------------------------------------------------------
