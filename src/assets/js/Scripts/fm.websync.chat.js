...
fm.websync.chat.clientExtensions = (function() {
  ...
  clientExtensions.onBindFailure = function() {
    var args, dynamicValue, error, exception, state;
    args = arguments[0];
    try {
      ...
      exception = error;
      return fm.log.error("Could not process bind failure.", exception);
    } finally {
  ...
  clientExtensions.onBindSuccess = function() {
    ...
    try {
      ...
      exception = error;
      return fm.log.error("Could not process bind success.", exception);
    } finally {
  ...
  clientExtensions.onSubscribeFailure = function() {
    ...
    try {
      ...
      if (state.getBindSuccess()) {
        return fm.websync.chat.clientExtensions.raiseJoinFailure(dynamicValue, args, args.getRetry(), args.getIsResubscribe(), args.getChannels(), new Error(fm.stringExtensions.format("Join failed (bind succeeded, but subscribe failed [{0}]).", args.getException().message)));
      } else {
        return fm.websync.chat.clientExtensions.raiseJoinFailure(dynamicValue, args, args.getRetry(), args.getIsResubscribe(), args.getChannels(), new Error(fm.stringExtensions.format("Join failed (bind failed [{0}] and subscribe failed [{1}]).", state.getBindFailureArgs().getException().message, args.getException().message)));
      }
    } catch (error) {
      exception = error;
      return fm.log.error("Could not process subscribe failure.", exception);
    } finally {
  ...
  clientExtensions.onSubscribeSuccess = function() {
    var _var0, _var1, args, client, clientArray, dictionary, dynamicValue, error, error1, exception, exception1, exception2, i, j, len, len1, state, user, users;
    args = arguments[0];
    try {
      dynamicValue = args.getDynamicValue(fm.websync.chat.clientExtensions._argsKey);
      state = dynamicValue.getDynamicValue(fm.websync.chat.clientExtensions._joinStateKey);
      ...
      if (!state.getBindSuccess()) {
        return fm.websync.chat.clientExtensions.raiseJoinFailure(dynamicValue, state.getBindFailureArgs(), state.getBindFailureArgs().getRetry(), args.getIsResubscribe(), args.getChannels(), new Error(fm.stringExtensions.format("Join failed (subscribe succeeded, but bind failed [{0}]).", state.getBindFailureArgs().getException().message)));
      } else {
        clientArray = null;
        try {
          ...
          fm.websync.chat.clientExtensions.raiseJoinFailure(dynamicValue, args, false, args.getIsResubscribe(), args.getChannels(), exception);
          return;
        } finally {
      ...
      return fm.log.error("Could not process subscribe success.", exception);
    } finally {
  ...
  clientExtensions.onUnbindFailure = function() {
    ...
    try {
      ...
      exception = error;
      return fm.log.error("Could not process unbind failure.", exception);
    } finally {
  ...
  clientExtensions.onUnbindSuccess = function() {
    ...
    try {
      ...
      exception = error;
      return fm.log.error("Could not process unbind success.", exception);
    } finally {
  ...
  clientExtensions.onUnsubscribeFailure = function() {
    ...
    try {
      ...
      exception = error;
      return fm.log.error("Could not process unsubscribe failure.", exception);
    } finally {
  ...
  clientExtensions.onUnsubscribeSuccess = function() {
    ...
    try {
      ...
      exception = error;
      return fm.log.error("Could not process unsubscribe success.", exception);
    } finally {
  ...
  clientExtensions.raiseJoinFailure = function() {
    ...
    args = arguments[1];
    retry = arguments[2];
    isRejoin = arguments[3];
    channels = arguments[4];
    exception = arguments[5];
